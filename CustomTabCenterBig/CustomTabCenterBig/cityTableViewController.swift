...
class cityTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MyCell_ID", for: indexPath)

        // Configure the cell...
        //var cell:myTableViewCell = tableView.dequeueReusableCell(withIdentifier: "MyCell_ID", for: indexPath) as! myTableViewCell
        cell.textLabel?.text = array[indexPath.count]
